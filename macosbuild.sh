...
# clone into libs : choc, clap, clap-helpers, fmt, juce, simde, 
# git clone https://github.com/Xenakios/sst-basic-blocks.git
# sst-cpputils 
# sst-filters, 
# git clone https://github.com/surge-synthesizer/tuning-library.git
