...
struct GrainEvent
{
    ...
    std::array<float, 8> auxenvparams = {0.0f};
...
class GranulatorVoice
{
  public:
    ...
    void process(float *outputs, int nframes)
    {
        ...
        process_mod_matrix(normphase, auxenvparams, modulation_slots, *aux_envelopes,
                           modulatedvalues);
...
class ToneGranulator
{
  public:
    ...
    struct GrainEnvelopeVisMessage
    {
        ...
        std::array<float, GranulatorVoice::num_aux_envelopes * 2> auxenvparams;
    ...
    enum PARAMS
    {
        ...
        PAR_LEARNSNAPSHOTS0108 = 8000000,
        PAR_LEARNSNAPSHOTS0916 = 8000001,
        PAR_LEARNPREVIOUSSNAPSHOT = 8000002,
        PAR_LEARNNEXTSNAPSHOT = 8000003
    };
    enum SI
    {
        NOSOURCE,
